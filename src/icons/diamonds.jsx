export const DiamondsIcon = ({height, width}) => {
  return (
    <svg stroke="red" fill="red" strokeWidth="0" viewBox="0 0 512 512" height={height || '1rem'} width={width || '1rem'} xmlns="http://www.w3.org/2000/svg">
